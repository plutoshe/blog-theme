...
\begin{document}
	...
	\par{\centering
		...
		\begin{itemize}
			...
			\item Design lava system to create urging situation for a puzzle.
			
			\item Develop the map system, player actions, player attacks.
		...
		\leftline{Soft Skills: Reading, Communication, Responsibility, Teamwork, Problem Solving, Decisiveness, Negotiation}
		\hspace{0.3in}
